 ...
 * @link     https://accolade.fi
 */
class Accolade_Button_Model_Key extends Mage_Core_Model_Abstract
{
    ...
    /**
     * Accolade_Button_Model_Key constructor function
     *
     * @return null
     */
    ...
    {
        parent::_construct();
        $this->_init('accolade_button/key', 'id');
    }
    ...
    public function checkAllKeys()
    {
        ...
        if ($keys->getSize() == 0) {
            foreach ($this->_keyScopes as $scope) {
                Mage::helper('accolade_button/api')->newKey($scope);
            }
        }
    }
}
